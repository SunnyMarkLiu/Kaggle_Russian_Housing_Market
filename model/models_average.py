...
average_result1 = 0.30 * (0.784 * xgboost_model_031051['price_doc'] + 0.216 * xgboost_model_031191['price_doc']) + \
...
# average_result1 0.30957
average_result = 0.784 * average_result1 + 0.216 * xgboost_model_031051['price_doc']  # 0.30942
