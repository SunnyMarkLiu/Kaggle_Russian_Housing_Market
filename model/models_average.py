...
average_result1 = 0.35 * (0.784 * xgboost_model_031051['price_doc'] + 0.216 * xgboost_model_031191['price_doc']) + \
                  0.30 * (0.784 * xgboost_model_031211['price_doc'] + 0.216 * xgboost_model_031284['price_doc']) + \
...
# average_result1
average_result = 0.784 * average_result1 + 0.216 * xgboost_model_031051['price_doc']  # 0.30935
